...
export const recreation: Location[] = [
  {
    ...
    periods: [
      ...
      { period: 'summer-2027', hours: summerFitness, note: 'Summer hours' },
    ],
    overrides: [
      { from: '2026-09-07', hours: 'unknown', note: 'Labor Day hours not published; call 617-627-5215' },
      ...
      { from: '2027-05-24', to: '2027-05-31', hours: summerFitness, note: 'Summer hours' },
  ...
  },
  {
    ...
    overrides: [
      ...
      { from: '2026-10-31', hours: 'closed', note: 'No rec swim Oct 31' },
      {
        ...
        note: 'No evening rec swim Nov 24',
      },
